package com.github.oleather.models.controllers
...
public class PID {
    ...
    public fun calculate(goal: Double, measurement: Double, feedforward: Double, dt: Double) =
        calculate(goal, measurement, dt) + f * feedforward
